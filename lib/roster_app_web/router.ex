defmodule RosterAppWeb.Router do
  ...
  import RosterAppWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {RosterAppWeb.Layouts, :root}
  ...
  if Application.compile_env(:roster_app, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: RosterAppWeb.Telemetry
