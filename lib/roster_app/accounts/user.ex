defmodule RosterApp.Accounts.User do
  ...
  schema "users" do
    ...
    has_many :user_qualifications, Orgs.UserQualification
    has_many :work_types, through: [:user_qualifications, :work_type]
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, RosterApp.Repo)
  ...
  """
  def valid_password?(%RosterApp.Accounts.User{hashed_password: hashed_password}, password)
